            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('admin.subcategories')}}">Manage Subcategory</a></li>
                            <li><a href="{{route('admin.subcategory.add')}}">Add Subcategory</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{route('admin.products')}}">Manage Product</a></li>
                            </ul>
                        </li>
                </ul>
            </div>
